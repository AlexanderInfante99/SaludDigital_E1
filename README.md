...
### 🧩 C1	Crea estructuras y organiza proyectos en VS Code con control de versiones y entorno virtual
### 📊 C2	Aplica técnicas de generación y limpieza de datos con Python
### 🍃 C3	Administra bases de datos NoSQL con MongoDB
### 📈 C4	Interpreta y visualiza información de pacientes para la toma de decisiones
### 💻 C5	Integra herramientas modernas en entornos de desarrollo reales

## 📘 Producto Final Esperado
Un repositorio en GitHub con:
•	Carpeta con los notebooks ejecutables
•	main.py como orquestador del flujo (Opcional)
•	README.md detallando las fases
•	Resultados visuales y conclusiones